...
class MockEntityFactory:
    ...
    def create_item(self, type_id, x, y):
        ...
        self.world.add_component(e, ItemStats(name="Dropped Item", type_id=type_id, cost=0, is_portable=True))
...
def test_inventory_system_pickup(world):
    ...
    world.add_component(item, ItemStats(name="Test Item", type_id="test_item", cost=10, is_portable=True))
...
def test_inventory_system_drop(world):
    ...
    # Request Drop
    world.add_component(player, InventoryDropRequest(item_type_id="test_item", quantity=1))
...
def test_persistence_inventory():
    ...
    serializer = WorldSerializer(w, [InventoryComponent, StableIDComponent, Persistable])
    ...
    w2 = World()
    # serialize_entity returns a dict. load_from_data expects a list of dicts.
    serializer2 = WorldSerializer(w2, [InventoryComponent, StableIDComponent, Persistable])
