...
@pytest.fixture
def mock_pygame_gui() -> MagicMock:
    """
    Mocks the pygame_gui module.
    """
...
def test_gameloop_init(mock_pygame: MagicMock, mock_pygame_gui: MagicMock, mock_resource_manager: MagicMock, mock_world: MagicMock) -> None:
    """
    Tests initialization of the GameLoop.
    """
...
def test_set_headless(mock_pygame: MagicMock, mock_pygame_gui: MagicMock, mock_resource_manager: MagicMock, mock_world: MagicMock) -> None:
    """
    Tests toggling headless mode.
    """
    loop = GameLoop()
...
def test_handle_events_quit(mock_pygame: MagicMock, mock_pygame_gui: MagicMock, mock_resource_manager: MagicMock, mock_world: MagicMock) -> None:
    """
    Tests that the QUIT event stops the game loop.
    """
    loop = GameLoop()
...
def test_tick(mock_pygame: MagicMock, mock_pygame_gui: MagicMock, mock_resource_manager: MagicMock, mock_world: MagicMock) -> None:
    """
    Tests the tick method updates systems.
    """
    loop = GameLoop()
...
def test_tick_paused(mock_pygame: MagicMock, mock_pygame_gui: MagicMock, mock_resource_manager: MagicMock, mock_world: MagicMock) -> None:
    """
    Tests that world updates are skipped when paused.
    """
    loop = GameLoop()
    loop.paused = True
...
def test_tick_timescale(mock_pygame: MagicMock, mock_pygame_gui: MagicMock, mock_resource_manager: MagicMock, mock_world: MagicMock) -> None:
    """
    Tests that time scale affects world update dt.
    """
    loop = GameLoop()
    loop.time_scale = 2.0
...
def test_run(mock_pygame: MagicMock, mock_pygame_gui: MagicMock, mock_resource_manager: MagicMock, mock_world: MagicMock) -> None:
    """
    Tests the main run loop logic (setup, loop, quit).
    """
    loop = GameLoop()
...
def test_run_headless(mock_pygame: MagicMock, mock_pygame_gui: MagicMock, mock_resource_manager: MagicMock, mock_world: MagicMock) -> None:
    """
    Tests that run loop skips drawing in headless mode.
    """
    loop = GameLoop()
    loop.set_headless(True)
