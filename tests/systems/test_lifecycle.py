...
def test_handle_growth(lifecycle_system, world):
    # Setup Baby -> Child
    entity = world.create_entity()
    # Note: If max_health is 100 for a Baby, it implies the Adult max_health would be 200.
    # Because Baby is 50% of Adult.
    ...
    # With the fix (doubling max_health), 100 * 2 = 200.
    assert stats.max_health == 200
