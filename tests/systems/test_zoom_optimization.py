...
def test_render_system_quantizes_scale():
    ...
    try:
        ...
        print(
            f"Assertion failed for Zoom 1.0. Actual calls: {render_system.surface_cache.get_surface.call_args_list}"
        )
        raise e
    ...
    try:
        ...
        print(
            f"Assertion failed for Zoom 1.001. Actual calls: {render_system.surface_cache.get_surface.call_args_list}"
        )
        raise e
    ...
    try:
        ...
        print(
            f"Assertion failed for Zoom 1.06. Actual calls: {render_system.surface_cache.get_surface.call_args_list}"
        )
        raise e
