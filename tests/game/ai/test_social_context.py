...
from yukkuri_game.game.yukkuri_components import (
    YukkuriStats, Needs, AIState, Predator, RelationshipRegistry, RelationshipData
)
...
class TestSocialContext:
    ...
    def create_yukkuri(self, world, type_id, x, y, is_predator=False, prey_tags=None):
        ...
        if is_predator:
            world.add_component(e, Predator(prey_tags=prey_tags or set(), prey_sense_radius=300))
    ...
    def test_diff_type_is_neutral(self, world):
        ...
        captured_context = {}
        selector.engine.select_action = lambda c, *a: (captured_context.update(c) or "Idle")
        selector.update()
    ...
    def test_predator_sees_prey_as_enemy(self, world):
        ...
        me = self.create_yukkuri(world, "flandre", 0, 0, is_predator=True, prey_tags={"reimu"})
    ...
    def test_prey_sees_predator_as_enemy(self, world):
        ...
        me = self.create_yukkuri(world, "reimu", 0, 0)
        pred = self.create_yukkuri(world, "flandre", 50, 0, is_predator=True, prey_tags={"reimu"})
