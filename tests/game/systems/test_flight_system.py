...
from yukkuri_game.game.yukkuri_components import Flight, FlightState, Needs, EmotionalState
from yukkuri_game.game.components import MovementController, Transform, PhysicsBody
...
class TestFlightSystem:
    ...
    def create_flying_entity(self, world, state=FlightState.GROUNDED, stamina=100.0, altitude=0.0):
    ...
    def test_takeoff_ascends_and_drains_stamina(self, system, world):
        ...
        _, flight = self.create_flying_entity(world, FlightState.TAKEOFF, stamina=100.0, altitude=0.0)
    ...
    def test_swoop_descends_rapidly(self, system, world):
        ...
        _, flight = self.create_flying_entity(world, FlightState.SWOOPING, altitude=100.0)
    ...
    def test_fall_damage_and_stun(self, system, world):
        ...
        entity, flight = self.create_flying_entity(world, FlightState.FALLING, altitude=5.0)
        flight.vertical_speed = 10.0
