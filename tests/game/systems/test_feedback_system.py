...
def mock_factory(mock_world):
    ...
    mock_world.services.get.side_effect = (
        lambda service_type: factory
        if service_type == EntityFactory
        else mock_world.services.get_return_value
    )
    return factory
...
class TestFeedbackSystem:
    ...
    def test_on_entity_sold(
        ...
        mock_create_text.assert_called_with(
            feedback_system.world, 50, 20, "+$100", (255, 215, 0), size=24
        )
    ...
    def test_on_growth(
        ...
        mock_create_text.assert_called_with(
            feedback_system.world, 100, 60, "Level Up!", (255, 255, 0), size=24
        )
    ...
    def test_on_death(
        ...
        mock_create_text.assert_called_with(
            feedback_system.world, 200, 170, "Dead...", (128, 128, 128), size=20
        )
    ...
    def test_on_trained(
        ...
        mock_create_text.assert_called_with(
            feedback_system.world, 300, 270, "Trained!", (0, 255, 255), size=20
        )
