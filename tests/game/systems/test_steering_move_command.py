...
from yukkuri_game.game.components import MoveCommand, Transform, MovementController, SteeringComponent, PhysicsBody
...
class TestSteeringMoveCommand:
    ...
    def test_move_command_processing(self, world, system):
        ...
        world.get_components_tuple.side_effect = [
            [(entity_id, (trans, movement, steering, phys, move_cmd))], # Phase A: MoveCommand
            [] # Phase B: Path-based
        ]
    ...
    def test_move_command_override_path(self, world, system):
        ...
        world.services.try_get.return_value = None
        world.has_component.return_value = True # Simulate entity has MoveCommand during Phase B check
