...
class TestMouseLightSystem:
    ...
    def system(self, world, mock_camera):
        ...
        with patch('yukkuri_game.game.systems.mouse_light_system.pygame') as mock_pygame:
            mock_pygame.display.get_surface.return_value.get_size.return_value = (800, 600)
