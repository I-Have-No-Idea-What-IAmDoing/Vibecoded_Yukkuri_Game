...
|---|------|-------|-------------|--------|
| 1 | Biology & Metabolism Tests | Tier 1-4 tests for Need Decay, Metabolism, Waste, Lifecycle, and Breeding features. | None | DONE |
| 2 | Social & Personality Tests | Tier 1-4 tests for Proximity, opinion, Gossip, Traits, and Skills features. | Milestone 1 | DONE |
| 3 | Environment & Feedback Tests | Tier 1-4 tests for Time, Day/Night cycle, Darkness stress, Cursor lights, and Audio/Visual Feedback features. | Milestone 1 | DONE |
| 4 | Real-World Workload Scenarios | Tier 4 E2E compound scenarios tying biology, social, environment together. | Milestone 1, 2, 3 | DONE |
