...
def run_benchmark():
    ...
    for i in range(cycles):
        ...
        logger.info(f"  Memory after spawn: {spawn_mem:.2f} MB (+{spawn_mem - start_scene_mem:.2f} MB)")
        ...
        logger.info(f"  Net change this cycle: {end_cycle_mem - start_scene_mem:.2f} MB")
