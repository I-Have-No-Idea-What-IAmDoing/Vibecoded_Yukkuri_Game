...
class HUD:
    ...
    def on_notification(self, event: NotificationEvent) -> None:
        """
        Handles NotificationEvent.

        Args:
            event (NotificationEvent): The notification event.
        """
        self.log_message(event.message)

    def log_message(self, message: str) -> None:
        """
        Logs a message to the notification log.

        Args:
            message (str): The message to log.
        """
        if self.layout.notification_log:
            self.layout.notification_log.add_message(message)
