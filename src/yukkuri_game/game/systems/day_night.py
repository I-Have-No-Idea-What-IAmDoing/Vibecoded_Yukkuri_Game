...
class DayNightSystem(System):
    ...
    def update(self, dt: float) -> None:
        ...
        # Let's define a game day length. e.g., 24 minutes = 1 game day?
        # If time_scale is 1.0.

        # Simple mapping: TimeService.time_elapsed is total seconds.
        # Game Day Length = 600 seconds (10 minutes)
        GAME_DAY_LENGTH = 600.0

        elapsed = self.time_service.time_elapsed
        day_progress = (elapsed % GAME_DAY_LENGTH) / GAME_DAY_LENGTH
