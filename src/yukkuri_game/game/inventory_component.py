...
class InventoryComponent:
    ...
    def add(self, item_type_id: str, count: int = 1, stack_limit: int = 99) -> int:
        ...
        while remaining > 0 and len(self.items) < self.capacity:
            ...
            self.items.append(ItemStack(item_type_id=item_type_id, quantity=take_for_new_stack))
    ...
    def get_total(self, item_type_id: str) -> int:
        ...
        """
        return sum(item.quantity for item in self.items if item.item_type_id == item_type_id)
