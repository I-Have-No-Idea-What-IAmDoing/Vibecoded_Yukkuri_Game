...
class TestEconomyService(unittest.TestCase):
    ...
    def test_initialization(self) -> None:
        self.assertEqual(self.economy.money, 1000)

    def test_add_money(self) -> None:
        self.economy.add_money(500)
        self.assertEqual(self.economy.money, 1500)
    ...
    def test_remove_money(self) -> None:
        ...
        self.assertEqual(self.economy.money, 500)
    ...
    def test_set_money(self) -> None:
        ...
        self.assertEqual(self.economy.money, 5000)

        # Clamping
        self.economy.set_money(-100)
        self.assertEqual(self.economy.money, 0)
