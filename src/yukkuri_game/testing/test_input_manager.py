...
class TestInputManager(unittest.TestCase):
    ...
    def test_input_consumption(self):
        ...
        is_consumed = self.input_manager._is_consumed(K_UP, InputContext.GAMEPLAY, is_mouse=False)
        ...
        is_consumed = self.input_manager._is_consumed(K_UP, InputContext.MENU, is_mouse=False)
